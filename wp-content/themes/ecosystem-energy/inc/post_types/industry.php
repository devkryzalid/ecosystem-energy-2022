...
{
    $labels = array(
        'name'                     => __('Industries', 'ecosystem-energy'),
        'singular_name'            => __('Industry', 'ecosystem-energy'),
        'all_items'                => __('All industries', 'ecosystem-energy'),
        ...
        'view_item'                => __('See industry', 'ecosystem-energy'),
        'search_items'             => __('Find industry', 'ecosystem-energy'),
    ...
    $args = array(
        ...
        'query_var'           => true,
        'can_export'          => true,
        'rewrite'             => array('slug' => __('industries', 'ecosystem-energy'), 'with_front' => true),
    );
