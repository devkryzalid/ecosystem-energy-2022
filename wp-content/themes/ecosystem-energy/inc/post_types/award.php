...
{
    $labels = array(
        'name'                     => __('Awards', 'ecosystem-energy'),
        'singular_name'            => __('Award', 'ecosystem-energy'),
        'all_items'                => __('All awards', 'ecosystem-energy'),
        ...
        'view_item'                => __('See awards', 'ecosystem-energy'),
        ...
        'menu_name'                => __('Awards', 'ecosystem-energy'),
    ...
    $args = array(
        ...
        'query_var'           => true,
        'can_export'          => true,
        'rewrite'             => array('slug' => __('awards', 'ecosystem-energy'), 'with_front' => true),
    );
